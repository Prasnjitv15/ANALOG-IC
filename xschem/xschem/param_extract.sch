...
S {}
E {}
N -150 -80 -150 -30 {lab=vgds}
N -150 -80 20 -80 {lab=vgds}
N 20 -80 20 -30 {lab=vgds}
N -60 -0 -20 -0 {lab=vgds}
N -60 -80 -60 0 {lab=vgds}
...
C {vsource.sym} -150 0 0 0 {name=Vds value=1 savecurrent=false}
...
"
spice_ignore=false}
C {vsource.sym} 20 80 0 0 {name=Vsb value=0 savecurrent=false}
C {gnd.sym} -60 130 0 0 {name=l1 lab=GND}
C {lab_wire.sym} -120 -80 0 0 {name=p1 sig_type=std_logic lab=vgds}
